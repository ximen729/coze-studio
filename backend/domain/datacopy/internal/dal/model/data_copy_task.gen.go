...
type DataCopyTask struct {
	MasterTaskID  string `gorm:"column:master_task_id;primaryKey;comment:复制任务ID" json:"master_task_id"`             // 复制任务ID
	OriginDataID  int64  `gorm:"column:origin_data_id;primaryKey;comment:源id" json:"origin_data_id"`                // 源id
	...
	DataType      int32  `gorm:"column:data_type;primaryKey;comment:数据类型 1:knowledge, 2:database" json:"data_type"` // 数据类型 1:knowledge, 2:database
